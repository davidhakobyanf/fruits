            ...
            <ul className="mb-6 flex flex-col gap-1.5">
              ...
              <li>
                <NavLink
                  to="/toys"
                  className={`group relative flex items-center gap-2.5 rounded-sm py-2 px-4 font-medium text-bodydark1 duration-300 ease-in-out hover:bg-graydark dark:hover:bg-meta-4 ${
                    pathname.includes('toys') && 'bg-graydark dark:bg-meta-4'
                  }`}
                >
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                  ...
                  >
                    <path
                      d="M95.731 352.468H52.706c-.796 0-1.581.043-2.356.14.774.086 1.56.129 2.356.129h43.025c.796 0 1.581-.043 2.356-.129a18.95 18.95 0 0 0-2.356-.14z" />
                    <path
                      d="M487.154 388.618a31.545 31.545 0 0 0 3.871-15.175c0-17.496-14.234-31.731-31.731-31.731h-10.756v-51.985c0-5.941-4.817-10.756-10.756-10.756s-10.756 4.816-10.756 10.756v51.985H416.27c-8.477 0-16.445 3.3-22.438 9.291-5.992 5.992-9.293 13.961-9.293 22.44 0 3.574.603 7.01 1.697 10.219h-260.47a31.58 31.58 0 0 0 1.697-10.219 31.654 31.654 0 0 0-7.791-20.841 31.666 31.666 0 0 0 7.791-20.839c0-17.496-14.234-31.731-31.731-31.731H84.975V156.165c0-19.693 13.821-36.207 32.269-40.382v9.727c0 17.496 14.234 31.731 31.731 31.731s31.731-14.235 31.731-31.731v-9.816c18.643 4.029 32.656 20.641 32.656 40.472v68.84c0 25.201 14.692 47.449 37.238 57.464v7.342c0 17.496 14.234 31.731 31.731 31.731s31.731-14.235 31.731-31.731v-11.093c18.508-11.336 30.139-31.722 30.139-53.714v-22.588c0-22.835 18.577-41.412 41.412-41.412 11.059 0 21.462 4.307 29.284 12.119 7.821 7.83 12.128 18.233 12.128 29.293v8.164c0 5.941 4.817 10.756 10.756 10.756s10.756-4.816 10.756-10.756v-8.164c0-16.802-6.542-32.604-18.43-44.504-11.892-11.878-27.694-18.42-44.495-18.42-34.697 0-62.924 28.228-62.924 62.924v22.588c0 9.277-3.16 18.111-8.627 25.232v-3.451c0-8.478-3.3-16.447-9.293-22.439-5.991-5.992-13.961-9.292-22.438-9.292-17.497 0-31.731 14.235-31.731 31.731v10.756c-9.755-7.67-15.726-19.502-15.726-32.538v-68.84c0-31.725-23.604-58.026-54.169-62.302V82.485c0-8.478-3.3-16.447-9.293-22.44-5.992-5.991-13.961-9.291-22.438-9.291-17.497 0-31.731 14.235-31.731 31.731v11.429c-30.378 4.442-53.782 30.662-53.782 62.252v143.866H52.706c-8.477 0-16.445 3.3-22.438 9.291-5.992 5.992-9.293 13.961-9.293 22.44a31.66 31.66 0 0 0 7.802 20.851c-5.042 5.775-7.802 13.087-7.802 20.83a31.542 31.542 0 0 0 3.871 15.175C10.115 396.144 0 411.461 0 429.107v21.384c0 5.941 4.817 10.756 10.756 10.756h490.487c5.94 0 10.756-4.816 10.756-10.756v-21.384c.001-17.646-10.114-32.963-24.845-40.489zM272.113 246.787c0-5.634 4.584-10.219 10.219-10.219 2.731 0 5.297 1.062 7.227 2.992a10.15 10.15 0 0 1 2.991 7.226v43.025c0 5.634-4.584 10.219-10.219 10.219s-10.219-4.584-10.219-10.219v-43.024zM138.756 82.485c0-5.634 4.584-10.218 10.219-10.218 2.731 0 5.299 1.063 7.228 2.992a10.148 10.148 0 0 1 2.99 7.226v43.025c0 5.634-4.584 10.218-10.219 10.218s-10.219-4.584-10.219-10.218V82.485zm270.285 283.732a10.154 10.154 0 0 1 7.228-2.992h43.025c5.634 0 10.219 4.584 10.219 10.218s-4.584 10.219-10.219 10.219h-43.025c-5.634 0-10.219-4.584-10.219-10.219 0-2.732 1.062-5.299 2.991-7.226zM45.478 324.536a10.154 10.154 0 0 1 7.228-2.992h43.025c5.634 0 10.219 4.584 10.219 10.219 0 5.213-3.894 9.578-9.05 10.155a10.65 10.65 0 0 1-1.168.063H52.706c-.396 0-.789-.021-1.159-.062-5.165-.578-9.059-4.944-9.059-10.156a10.144 10.144 0 0 1 2.99-7.227zm.001 41.68a10.195 10.195 0 0 1 5.229-2.79c.665.041 1.332.067 1.997.067H95.73c.661 0 1.323-.025 1.983-.066 4.748.916 8.235 5.082 8.235 10.015 0 5.634-4.584 10.219-10.218 10.219H52.706v.001c-5.634 0-10.218-4.584-10.218-10.219a10.141 10.141 0 0 1 2.991-7.227zm445.008 73.518H21.513v-10.627c0-13.197 10.736-23.933 23.933-23.933H466.554c13.197 0 23.933 10.736 23.933 23.933v10.627z" />
                    <path
                      d="M437.782 235.041c-5.94 0-10.756 4.816-10.756 10.756v7.895c0 5.941 4.817 10.756 10.756 10.756s10.756-4.816 10.756-10.756v-7.895c0-5.94-4.817-10.756-10.756-10.756z" />
                  </svg>
                  Toys
                </NavLink>
              </li>
              <li>
                ...
                >
                  <svg xmlns="http://www.w3.org/2000/svg" version="1.0" width="18" height="18" stroke={'#fff'}
                       viewBox="0 0 512.000000 512.000000" preserveAspectRatio="xMidYMid meet">
                    <g transform="translate(0.000000,512.000000) scale(0.100000,-0.100000)" fill="#000000"
                       stroke="none">
                      <path fill={'#fff'}
                            d="M1120 4588 c-52 -27 -78 -60 -90 -114 -6 -22 -10 -654 -10 -1486 l0 -1448 -172 0 c-95 0 -190 -5 -210 -10 -52 -15 -94 -53 -113 -105 -31 -81 2 -279 70 -424 110 -232 309 -395 565 -463 l85 -23 1230 0 1230 0 85 22 c303 80 536 311 622 618 l23 80 3 1603 c2 1077 -1 1615 -8 1641 -14 52 -46 90 -94 112 -39 18 -104 19 -1606 19 l-1566 0 -44 -22z m2975 -1813 c0 -1417 -1 -1493 -18 -1550 -52 -169 -186 -303 -350 -350 -83 -24 -215 -22 -298 4 -188 59 -325 224 -350 421 -6 47 -15 101 -20 122 -11 44 -64 93 -116 107 -25 7 -301 11 -805 11 l-768 0 0 1365 0 1365 1363 -2 1362 -3 0 -1490z" />
                      <path fill={'#fff'} d="M1880 3580 l0 -170 170 0 170 0 0 170 0 170 -170 0 -170 0 0 -170z" />
                      <path fill={'#fff'} d="M2560 3580 l0 -170 510 0 510 0 0 170 0 170 -510 0 -510 0 0 -170z" />
                      <path fill={'#fff'} d="M1880 2900 l0 -170 170 0 170 0 0 170 0 170 -170 0 -170 0 0 -170z" />
                      <path fill={'#fff'} d="M2560 2900 l0 -170 510 0 510 0 0 170 0 170 -510 0 -510 0 0 -170z" />
                      <path fill={'#fff'} d="M1880 2220 l0 -170 170 0 170 0 0 170 0 170 -170 0 -170 0 0 -170z" />
                      <path fill={'#fff'} d="M2560 2220 l0 -170 510 0 510 0 0 170 0 170 -510 0 -510 0 0 -170z" />
                    </g>
                  </svg>
                  Orders
                </NavLink>
                ...
                >
                  <svg xmlns="http://www.w3.org/2000/svg" version="1.0" width="18" height="18"
                    ...
                    <g transform="translate(0.000000,32.000000) scale(0.100000,-0.100000)" fill="#fff" stroke="none">
                      <path
                        d="M22 298 c-7 -7 -12 -33 -12 -60 0 -37 4 -50 19 -58 27 -14 94 -13 109 2 14 14 16 67 2 102 -8 23 -15 26 -58 26 -26 0 -53 -5 -60 -12z m98 -59 l0 -50 -42 3 -43 3 -3 48 -3 47 45 0 46 0 0 -51z" />
                      <path
                        d="M180 284 c-14 -35 -12 -88 2 -102 15 -15 82 -16 109 -2 15 8 19 21 19 58 0 27 -5 53 -12 60 -7 7 -34 12 -60 12 -43 0 -50 -3 -58 -26z m108 -41 l-3 -48 -42 -3 -43 -3 0 50 0 51 46 0 45 0 -3 -47z" />
                      <path
                        d="M17 134 c-12 -12 -8 -99 5 -112 7 -7 34 -12 60 -12 43 0 50 3 59 27 5 15 9 43 7 62 l-3 36 -60 3 c-34 2 -64 0 -68 -4z m103 -59 l0 -45 -45 0 -45 0 0 45 0 45 45 0 45 0 0 -45z" />
                      <path
                        d="M177 134 c-10 -11 -9 -68 3 -98 8 -23 15 -26 59 -26 61 0 73 14 69 77 l-3 48 -60 3 c-34 2 -64 0 -68 -4z m113 -59 l0 -45 -45 0 -45 0 0 45 0 45 45 0 45 0 0 -45z" />
                    </g>
                  </svg>
                  Categories
                </NavLink>
